...
function AddDiploma() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!user) {
      alert("You must be logged in to add a diploma")
      navigate("/login")
      return
    }
    ...
    formDataToSend.append("type", "diploma")
    ...
    <div className="container py-8">
      <div className="mx-auto" style={{ maxWidth: "42rem" }}>
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-3xl font-bold">Add Diploma</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="serialNumber" className="block text-sm font-medium mb-1">
                Diploma ID/Serial Number <span className="text-xs text-gray-500">(Optional)</span>
              </label>
              <input
                type="text"
                id="serialNumber"
          ...
          >
            ...
            <p className="text-sm mb-4" style={{ color: "var(--color-muted-foreground)" }}>
              Drag and drop your diploma file or click to browse
            </p>
            <input
              type="file"
              id="diplomaFile"
          ...
          <div className="flex justify-content-end">
            <button type="submit" className="btn btn-default" disabled={isSubmitting}>
              {isSubmitting ? "Saving..." : "Save Diploma"}
            </button>
          </div>
        </form>
      </div>
